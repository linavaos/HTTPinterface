...
public class WmsEditGoodsCase {
	
	public static void wmsEditgoods(String casename01,String casename02) throws IOException{
	   ...
	   //构造自定义的HttpClient对象
	    ...
	    LinkedHashMap<String, JSONArray> goodsdetail=jsonData.getJsonArray(casename02);
